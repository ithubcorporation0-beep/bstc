...
export const homeContent: HomeContent = {
  ...
  about: {
    ...
    intro:
      "Founded and led by Javed Hussain, Owner and Income Tax Practitioner (ITP), BSTC was established with one mission: Tax compliance and corporate registration should never be confusing, slow, or uncertain.",
    desc:
  ...
  testimonials: [
    {
      ...
      rating: 5,
      text: "BSTC made our corporate company registration and NTN procurement completely painless. Javed Hussain and his team are exceptionally knowledgeable and responsive.",
    },
    {
